        ...
        <header className="fixed top-0 z-50 w-full text-gray-100 transition-all duration-300 ease-in-out body-font fixed">
            <div className="container flex flex-row flex-wrap items-center p-5 mx-auto">
                ...
                <nav className="flex flex-wrap items-center justify-center text-base md:ml-auto">
                    ...
                    <a href="https://github.com/AkkilMG/PicDB-UI" className="mr-6 cursor-pointer bg-orange-600 hover:bg-orange-700 text-white px-3 py-2 font-semibold border-0 rounded hover:brightness-50 focus:outline-none">
                        Source Code
                    </a>
                </nav>
            </div>
